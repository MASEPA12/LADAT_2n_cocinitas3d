...
public class KitchenSelection : MonoBehaviour
{
    ...
    public List<GameObject> isInTheCenterOfTheTable;
    public bool isSomethingOnTheTable = false;
    ...
    void Start()
    {
        ...
        for (int i = 0; i< gameManagerScript.inTheBag.Length; i++)
        {
            Instantiate(gameManagerScript.inTheBag[i], placesOfTheStants[i].transform.position, Quaternion.identity);
